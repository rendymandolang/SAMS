...
The structured backup includes SaS Accounts Payable and Accounts Receivable master, invoice, line, payment/receipt, allocation, and subledger-sequence data.
